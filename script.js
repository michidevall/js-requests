...
sayHelloButton.addEventListener('mouseleave', invertHello);
    ...
    .then((res) => {
        console.log(res) => {
            for(i=0; i < res.data.length; i++){
                let beast = document.createElement('p');
                beast.style.color = "black";
                beast.textContent = res.data(i);
                document.body.appendChild(beast);
                zoo.appendChild(beasts);
            }
        }
...
document.getElementById('animals-button').addEventListener('click', ohMy).then*((res)=>{}
...
// const repeatMyParam = () => {
//     axios.get('https://localhost:3000/repeat/skittles')
//     .then(res) => {
//         console.log(res.data);
...
return axios.get ('http://localhost:3000/repeat/My-Head-Hurts')
.then(res => res.data)
...
//     })
// }
// repeatButton.addEventListener('click', theQuestion)
...
// let queryButton = document.querySelector('#query-button');
// const theQuestion = () => {
//     axios.get(http:'http://localhost:3000/query-test?skittles&mms)
//     .then((res) => {
//         console.log(res.data);
//     })
// }
// queryButton.addEventListener('click', theQuestion);

axios.get('http://localhost:3000/repeat?myquery=skittles&mms')
